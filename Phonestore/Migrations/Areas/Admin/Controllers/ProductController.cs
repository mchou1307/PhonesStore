...
using PhoneStore.Migrations.DB;
using PhoneStore.Migrations.Dtos.Product;
using PhoneStore.Models;
using PhoneStore.Models.DB;
using PhoneStore.Models.Dtos.Product;

namespace PhoneStore.Migrations.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class ProductController : Controller
    {
        ...
        public ProductController(PhoneStoreDbContext db, IWebHostEnvironment env) 
        { 
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateProductDtos p)
        {
